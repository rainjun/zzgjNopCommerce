...
namespace Nop.Plugin.Widgets.RainsAd
{
    public partial class RouteProvider : IRouteProvider
    {
        public void RegisterRoutes(RouteCollection routes)
        {
            ...
            //指定地址到conntroller
            routes.MapRoute("Plugin.Widgets.RainsAd.CreateAdInfo",
                "Plugins/WidgetsRainsAd/CreateAdInfo",
                new { controller = "WidgetsRainsAd", action = "CreateAdInfo" },
                new[] { "Nop.Plugin.Widgets.RainsAd.Controllers" }
           );
            //指定地址到conntroller
            routes.MapRoute("Plugin.Widgets.RainsAd.RainsAdInfoUpdate",
                "Plugins/WidgetsRainsAd/RainsAdInfoUpdate",
                new { controller = "WidgetsRainsAd", action = "RainsAdInfoUpdate" },
                new[] { "Nop.Plugin.Widgets.RainsAd.Controllers" }
           );
