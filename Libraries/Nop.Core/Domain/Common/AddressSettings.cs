...
namespace Nop.Core.Domain.Common
{
    public class AddressSettings : ISettings
    {
        ...
        /// <summary>
        /// Gets or sets a value indicating whether 'cityid' is enabled
        /// </summary>
        public bool CityIdEnabled { get; set; }

        /// <summary>
        /// Gets or sets a value indicating whether 'districtid' is enabled
        /// </summary>
        public bool DistrictIdEnabled { get; set; }
    }
}