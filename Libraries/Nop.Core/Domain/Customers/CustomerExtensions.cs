...
namespace Nop.Core.Domain.Customers
{
    public static class CustomerExtensions
    {
        ...
        /// <summary>
        /// Gets a value indicating whether customer is Distributor
        /// </summary>
        /// <param name="customer">Customer</param>
        /// <param name="onlyActiveCustomerRoles">A value indicating whether we should look only in active customer roles</param>
        /// <returns>Result</returns>
        public static bool IsDistributor(this Customer customer, bool onlyActiveCustomerRoles = true)
        {
            return IsInCustomerRole(customer, SystemCustomerRoleNames.Distributors, onlyActiveCustomerRoles);
        }
        #endregion
