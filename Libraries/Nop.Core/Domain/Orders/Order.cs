...
namespace Nop.Core.Domain.Orders
{
    ...
    public partial class Order : BaseEntity
    {
        ...
        private ICollection<Commission> _commissions;
        ...
        /// Gets or sets discount usage history
        /// </summary>
        public virtual ICollection<Commission> Commissions
        {
            get { return _commissions ?? (_commissions = new List<Commission>()); }
            protected set { _commissions = value; }
        }
