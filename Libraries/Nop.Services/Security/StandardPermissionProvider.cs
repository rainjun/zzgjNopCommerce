...
namespace Nop.Services.Security
{
    ...
    public partial class StandardPermissionProvider : IPermissionProvider
    {
        ...
        //rainAdd增加分销商的权限
        public static readonly PermissionRecord ManageCommissions = new PermissionRecord { Name = "Admin area. Manage Commissions", SystemName = "ManageCommissions", Category = "Commissions" };
        ...
        public virtual IEnumerable<DefaultPermissionRecord> GetDefaultPermissions()
        {
            return new[] 
            {
                ...
                //rainAdd add the default distributors‘s permission
                ,
                new DefaultPermissionRecord 
                {
                    CustomerRoleSystemName = SystemCustomerRoleNames.Distributors,
                    PermissionRecords = new[] 
                    {
                        AccessAdminPanel,
                        ManageCommissions,
