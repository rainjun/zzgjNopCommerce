...
namespace Nop.Services.Directory
{
    ...
    public partial class StateProvinceService : IStateProvinceService
    {
        ...
        /// <param name="showHidden">A value indicating whether to show hidden records</param>
        /// <returns>State/province collection</returns>
        public virtual IList<StateProvince> GetStateProvincesByParendId(int parentId, bool showHidden = false)
        {
            string key = string.Format(STATEPROVINCES_ALL_KEY, parentId);
            return _cacheManager.Get(key, () =>
            {
                var query = from sp in _stateProvinceRepository.Table
                            orderby sp.DisplayOrder
        ...
        /// <param name="showHidden">A value indicating whether to show hidden records</param>
        /// <returns>State/province collection</returns>
        public virtual IList<StateProvince> GetMyProvinces(bool showHidden = false)
        {
            string key = string.Format(STATEPROVINCES_ALL_KEY, "GetMyProvinces");
            return _cacheManager.Get(key, () =>
            {
                var query = from sp in _stateProvinceRepository.Table
                            orderby sp.DisplayOrder
