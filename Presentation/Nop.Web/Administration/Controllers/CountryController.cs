...
namespace Nop.Admin.Controllers
{
    public partial class CountryController : BaseAdminController
    {
        ...
        public ActionResult States(int countryId, DataSourceRequest command)
        {
            ...
            var gridModel = new DataSourceResult
            {
                Data = states.Select(x =>
                {
                    ...
                    vmodel.Breadcrumb = x.GetFormattedBreadCrumb(_stateProvinceService);
                    return vmodel;
                }),
                Total = states.Count
            };
        ...
        public ActionResult StateCreatePopup(int countryId)
        {
            ...
            //czhcom@163.com 2012年8月2日16:52:57
            model.ParentId = 0;

            PrepareAllStateProvinceModel(model);
        ...
        public ActionResult StateCreatePopup(string btnId, string formId, StateProvinceModel model)
        {
            ...
            ////czhcom@163.com 2012年8月2日16:54:43
            ////父级省份提供
            ...
            //        model.ParentProvinces.Add(new SelectListItem { Text = parentProvinces.GetFormattedBreadCrumb(_stateProvinceService), Value = parentProvinces.Id.ToString() });
            //    else
            //        model.ParentId = 0;
            //}
        ...
        public ActionResult StateEditPopup(int id)
        {
            ...
            ////czhcom@163.com 2012年8月2日16:55:50
            ////-->
            //model.ParentProvinces = new List<SelectListItem> { new SelectListItem { Text = "[None]", Value = "0" } };
            //if (model.ParentId > 0)
            //{
        ...
        public ActionResult StateEditPopup(string btnId, string formId, StateProvinceModel model)
        {
            ...
            ////czhcom@163.com 2012年8月2日16:57:12
            ////防止提交后 "dataSource" cannot be null.错误
            ////-->
            //model.ParentProvinces = new List<SelectListItem> { new SelectListItem { Text = "[None]", Value = "0" } };
            ////<--
        ...
        [NonAction]
        protected void PrepareAllStateProvinceModel(StateProvinceModel model)
        {
            if (model == null)
                throw new ArgumentNullException("model");
            ...
            var stateProvinces = _stateProvinceService.GetStateProvincesByCountryId(model.CountryId);
            foreach (var c in stateProvinces)
            {
                model.ParentProvinces.Add(new SelectListItem()
                {
                    Text = c.GetFormattedBreadCrumb(stateProvinces),
                    Value = c.Id.ToString()
                });
            }
        }
